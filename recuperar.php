...
try {
    ...
    Para isso, clique no link abaixo para realizar a troca de senha: <br>
     <a href="' . $_SERVER['SERVER_NAME'] . '/recuperar-senha/nova-senha.php?email=' . $usuario['email'] . '&token=' . $token . '"> Clique aqui para recuperar o acesso à sua conta!</a><br>
     . <br>
     Atenciosamente <br>
     Equipe do sistema...';
     ...
     //gravar as informações no banco na tabela recuperar-senha
